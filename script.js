...
const translations = {
  ...
  ru: {
    ...
    // Hero Section
    "hero-title": "Достигните своей мечты по SAT и поступите в лучшие университеты",
    ...
    "problem1-answer": "Мы предоставляем структурированную, персонализированную подготовку к SAT с проверенными методологиями и экспертным руководством",
    ...
    "teacher1-description": "Имея более 15 лет опыта в подготовке к SAT, доктор Джонсон помогла тысячам студентов достичь целевых баллов по математике. Она имеет докторскую степень по математике в MIT и специализируется на том, чтобы сделать сложные концепции простыми и понятными.",
    ...
    "teacher2-description": "Профессор Чен обладает обширными знаниями в области английской литературы и письма. Его инновационные методы преподавания постоянно помогают студентам улучшать навыки понимания прочитанного и написания эссе для SAT.",
    ...
    "teacher3-description": "Доктор Родригес специализируется на поступлении в колледжи и помогла сотням студентов пройти сложный процесс подачи заявок в университеты. Ее опыт распространяется на заявки на стипендии и подготовку к собеседованиям.",
    ...
    "teacher4-description": "Джеймс фокусируется на стратегиях сдачи тестов и методах управления временем. Его систематический подход к подготовке к SAT помог студентам максимально раскрыть свой потенциал и достичь значительного улучшения результатов.",
    ...
    "faq-a1": "Наши курсы обычно длятся 12-16 недель, с гибкими вариантами расписания, которые подходят вашим потребностям.",
    ...
    "faq-a6": "Наши премиум-курсы включают комплексное руководство по поступлению в колледж и поддержку при подаче заявок.",
